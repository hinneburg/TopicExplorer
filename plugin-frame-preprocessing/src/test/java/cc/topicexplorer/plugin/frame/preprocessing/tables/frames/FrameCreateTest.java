...
public class FrameCreateTest {
	...
	public void testCreateTable() throws SQLException {
		...
		verify(this.dbMock)
				.executeUpdateQuery(
						eq("CREATE TABLE FRAME$FRAMES (FRAME_ID INTEGER(11) NOT NULL KEY AUTO_INCREMENT, DOCUMENT_ID INT, TOPIC_ID INT, FRAME VARCHAR(255), START_POSITION INT, END_POSITION INT, ACTIVE BOOLEAN NOT NULL DEFAULT 1, FRAME_TYPE VARCHAR(255)) DEFAULT CHARSET=utf8 COLLATE=utf8_bin"));
	}
