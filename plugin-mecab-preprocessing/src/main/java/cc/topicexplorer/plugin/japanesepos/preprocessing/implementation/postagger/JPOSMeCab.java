...
//		System.out.println("dictionary filename: " + tagger.dictionary_info().getFilename());
//		System.out.println("dictionary charset: " + tagger.dictionary_info().getCharset());
		...
		for (;node != null; node = node.getNext())
		{
			...
			token = new JPOSToken(this.documentID, pos, this.getNodeTerm(node), node.getSurface(), node.getPosid());
